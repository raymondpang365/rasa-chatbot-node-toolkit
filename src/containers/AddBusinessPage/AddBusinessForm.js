...
import {
  ...
  SUBMIT_BUSINESS_FAILURE
} from "../../reducers/submitBusiness";
  ...
  render() {
    ...
    return (
      <div className={styles.addStoryForm}>
        <Helmet title='Login' />
        <text className={styles.addStoryFormTitle}>Add Your Business</text>
        ...
        <MakeAsyncFunction
          ...
          start={SUBMIT_BUSINESS}
          resolve={SUBMIT_BUSINESS_SUCCESS}
          reject={SUBMIT_BUSINESS_FAILURE}
        >
          {onSubmit => (
            <Form
              onSubmit={onSubmit}
